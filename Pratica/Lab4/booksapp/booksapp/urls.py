...
urlpatterns = [
    ...
    path('publisherbooks/<str:publisher>', views.getPublisherBooks, name="publisherbooks"),
    path('authorinsert/', views.insertAuthors, name="insertauthor"),
    path('publisherinsert/', views.insertPublisher, name="insertpublisher")
]
